...
def layout(view):
    ...
    components['chat'] = sg.Multiline(size=(35,12), background_color='#D0E9DD', key='-CHAT-', pad=(0,(10,0)), disabled=True)
    components['chat_input'] = sg.InputText(size=(25,1), key='-CHAT_INPUT-')
    components['chat_button'] = sg.Button('Send', key='-CHAT_SEND-', size=(10,1), pad=(0,(5,0)))
    components['toolbar'] = sg.Canvas(size=(70, 30), key='-CANVAS TOOLS-', expand_x=True, pad=(0,(10,0)))
